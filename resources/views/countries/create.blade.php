    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('countries.store') }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="country_code" type="text" class="form-control @error('country_code') is-invalid @enderror" name="country_code" value="{{ old('country_code') }}" autocomplete="country_code" autofocus>
